    ...
    <>
      ...
      >
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "var(--text-primary)", fontWeight: 700, fontSize: "1.05rem", letterSpacing: "-0.02em" }}>
          <div style={{ width: 28, height: 28, borderRadius: 7, overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg, var(--accent-blue), var(--accent-purple))" }}>
            <img src="/favicon.ico" alt="Orbit" width={28} height={28} style={{ objectFit: "contain", width: "100%", height: "100%" }} />
          </div>
          Orbit
        </Link>
