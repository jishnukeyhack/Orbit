  ...
  return (
    ...
    >
      ...
      <div style={{ height: 60, display: "flex", alignItems: "center", padding: collapsed ? "0 18px" : "0 16px", gap: 10, borderBottom: "1px solid var(--border-subtle)", flexShrink: 0 }}>
        <div style={{ width: 28, height: 28, borderRadius: 7, overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, background: "linear-gradient(135deg, var(--accent-blue), var(--accent-purple))" }}>
          <img
            src="/favicon.ico"
            alt="Orbit logo"
            width={28}
        ...
        {!collapsed && <span style={{ fontWeight: 700, fontSize: "1.05rem", letterSpacing: "-0.02em", whiteSpace: "nowrap" }}>Orbit</span>}
      </div>
